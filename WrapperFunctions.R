...
CalculateValidationErrors = function(){
	if(approach=="doMedian" | approach=="doNoMiss"){
		...
		pcPropValuesVect = ifelse(approach=="doMedian", "irrelevantForDoMedian", "irrelevantForDoMiss")
